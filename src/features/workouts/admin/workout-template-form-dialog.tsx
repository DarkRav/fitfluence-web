...
import type {
  ...
  CreateAdminWorkoutTemplatePayload,
  UpdateAdminWorkoutTemplatePayload,
...
type WorkoutTemplateFormDialogProps = {
  open: boolean;
  mode: "create" | "edit";
  workout?: AdminWorkoutTemplateRecord;
  isSubmitting: boolean;
  onOpenChange: (open: boolean) => void;
  onCreate: (payload: CreateAdminWorkoutTemplatePayload) => Promise<void>;
  onUpdate: (
...
function buildDefaultValues(workout?: AdminWorkoutTemplateRecord): WorkoutFormValues {
  return {
...
export function WorkoutTemplateFormDialog({
  open,
  mode,
  workout,
  isSubmitting,
  ...
  const title = useMemo(
    () => (mode === "create" ? ru.workouts.createWorkout : ru.common.actions.edit),
    [mode],
  );
